...
(Map<Countries, List<Territory>>, Map<Countries, List<Territory>>) getInputData() {
  /**Функция для инициализации входных данных
   * Function for initializing input data*/
  ...
  try {
    ...
    final mapAfter2010 = <Countries, List<Territory>>{
      Countries.turkish: [
        Territory(
          22,
          ['Чай'],
    ...
    return (mapAfter2010, mapBefore2010);

  } catch (error) {
    return (<Countries, List<Territory>>{}, <Countries, List<Territory>>{});
  }
